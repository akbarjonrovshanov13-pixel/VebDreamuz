      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Loyihangizni <span className="text-gradient bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Boshlang!</span>
          </h2>
            ...
            <Card className="bg-gradient-to-br from-cyan-500 to-blue-600 border-0">
              <CardContent className="p-6">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="https://t.me/vebdream" target="_blank" rel="noopener noreferrer">
                    Telegram Bot
